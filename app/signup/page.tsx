...
function SignupForm() {
  ...
  const [message, setMessage] = useState(envError || "");
  ...
  return (
    <main className="auth-page">
      ...
      <form className="auth-card" onSubmit={submit}>
        ...
        <div className="auth-actions"><button className="btn-primary" disabled={isSubmitting || Boolean(envError)}>{isSubmitting ? "Creating..." : "Create Account"}</button><a className="btn-outline" href={`/login?next=${encodeURIComponent(next)}`}>Already Have an Account</a></div>
