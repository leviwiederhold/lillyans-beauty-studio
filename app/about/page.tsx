  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f7f3f4" }}>
      ...
      <main className="policy-page-app">
        ...
        <p>Serving Cincinnati, Ohio, Lilly specializes in bridal artistry and permanent makeup — two services where precision and trust matter most. Every client receives her full attention in a clean, calm, professional studio.</p>
