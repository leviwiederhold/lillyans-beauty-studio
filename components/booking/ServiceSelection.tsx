...
export default function ServiceSelection({ onNext }: { onNext: (service: SelectedService) => void }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", background: "#faf8f6", fontFamily: "'DM Sans', sans-serif", color: "#2c2220", position: "relative", paddingBottom: selectedService ? 100 : 32 }}>
