...
function Navbar({ navOpen, setNavOpen }: { navOpen: boolean; setNavOpen: (open: boolean) => void }) {
  return (
    <nav>
      <a href="#" className="nav-logo">Lillyan&apos;s Beauty Studio<span>Greater Cincinnati Area</span></a>
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        <p className="hero-eyebrow">Wedding Makeup · Permanent Makeup · Greater Cincinnati Area</p>
        <h1>Your Wedding Day Deserves an <em>Artist</em>, Not Just a Makeup Artist</h1>
        <p className="hero-sub">Certified wedding makeup artist and permanent makeup specialist serving brides and clients throughout the Greater Cincinnati Area.</p>
...
function ServiceArea() {
  return <section className="service-area"><div className="reveal"><p className="section-label">Where We Serve</p><h2 className="section-title">Serving the Greater Cincinnati Area</h2><p className="section-sub">Located at 152 W Pike St in Fayetteville, OH and serving brides and clients throughout the Greater Cincinnati Area. Available for weddings throughout the Greater Cincinnati area and beyond. Travel within the United States may be available when travel expenses are covered.</p><div className="area-tags">{["Greater Cincinnati Area", "Cincinnati Area", "Southwest Ohio", "Wedding Travel Available"].map((x) => <span className="area-tag" key={x}>{x}</span>)}</div><div className="area-btns"><a href={MAPS_URL} target="_blank" className="btn-white">Get Directions</a><a href={`tel:${PHONE_TEL}`} className="btn-ghost-white">Call Now</a></div></div><div className="area-map reveal"><p>152 W Pike St<br />Fayetteville, OH 45118</p><small>Click &quot;Get Directions&quot; to open in Google Maps</small></div></section>;
}
...
function Footer() {
  return <footer><div className="footer-grid"><div className="footer-brand"><a href="#" className="nav-logo">Lillyan&apos;s Beauty Studio<span>Greater Cincinnati Area</span></a><p>Certified wedding makeup artist and permanent makeup specialist serving the Greater Cincinnati Area.</p><div className="footer-social"><a href="https://www.instagram.com/lillyans_beautystudio/" target="_blank" className="social-link">IG</a><a href="https://www.facebook.com/lillyansbeautystudio" target="_blank" className="social-link">FB</a><a href="https://www.tiktok.com/@lillyans_beautystudio" target="_blank" className="social-link">TK</a></div></div><div className="footer-col"><h4>Priority Services</h4><ul>{["Wedding Makeup", "Permanent Makeup", "Microblading", "Powder Brows", "Lip Blush"].map((x) => <li key={x}><a href={x === "Wedding Makeup" ? "#weddings" : "#permanent-makeup"}>{x}</a></li>)}</ul></div><div className="footer-col"><h4>Studio</h4><ul><li><a href="/about">About Lilly</a></li><li><a href="/memberships">Memberships</a></li><li><a href="#gallery">Gallery</a></li><li><a href="/care">Pre + Post Care</a></li><li><a href={GIFT_CARD_URL}>Gift Cards</a></li></ul></div><div className="footer-col"><h4>Contact</h4><ul><li><a href={`tel:${PHONE_TEL}`}>{PHONE}</a></li><li><a href={`mailto:${EMAIL}`}>{EMAIL}</a></li><li><a href={MAPS_URL} target="_blank">{ADDRESS}</a></li></ul></div></div><div className="footer-bottom"><p>© 2025 Lillyan&apos;s Beauty Studio · Greater Cincinnati Area · All rights reserved.</p><p>Certified Wedding Makeup Artist · Licensed Permanent Makeup Specialist</p></div></footer>;
}
