...
export async function requireAdmin() {
  ...
  // getUser() performs a network call; if Supabase is unreachable (e.g. paused /
  // over quota) it can throw. Treat any failure as "not signed in" rather than
  // letting it bubble up as a Server Components render crash.
  let user;
  try {
